...
export default function LocationMap() {
  return (
    <section className="text-center py-12 px-6 sm:px-12 md:px-20 bg-green-800 to-blue-100  font-[Roboto]">
      ...
      <div className="w-full max-w-md sm:max-w-lg md:max-w-3xl mx-auto mt-6 h-64 sm:h-72 md:h-80 rounded-lg overflow-hidden shadow-xl border-4 border-green-300 opacity-90">
        <iframe
